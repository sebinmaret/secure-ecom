...
import com.unbcs.oauth.OAuthServerApplication;
import com.unbcs.oauth.model.Client;
import com.unbcs.oauth.repository.ClientRepository;
...
public class JpaRegisteredClientRepository implements RegisteredClientRepository {
	...
	public JpaRegisteredClientRepository(ClientRepository clientRepository, PasswordEncoder passwordEncoder) {
		...
		ClassLoader classLoader = OAuthServerApplication.class.getClassLoader();
